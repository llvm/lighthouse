...
def params_with_constraints_imposed(
    ...
    wg_m = params.get(name := knob_name_prefix + "wg_m") or knob(name)
    wg_n = params.get(name := knob_name_prefix + "wg_n") or knob(name)
    sg_m = params.get(name := knob_name_prefix + "sg_m") or knob(name)
    sg_n = params.get(name := knob_name_prefix + "sg_n") or knob(name)
    k_tile = params.get(name := knob_name_prefix + "k_tile") or knob(name)
    load_a_m = params.get(name := knob_name_prefix + "load_a_m") or knob(name)
    load_a_k = params.get(name := knob_name_prefix + "load_a_k") or knob(name)
    load_b_k = params.get(name := knob_name_prefix + "load_b_k") or knob(name)
    load_b_n = params.get(name := knob_name_prefix + "load_b_n") or knob(name)
    prefetch_a_m = params.get(name := knob_name_prefix + "prefetch_a_m") or knob(name)
    prefetch_a_k = params.get(name := knob_name_prefix + "prefetch_a_k") or knob(name)
    prefetch_b_k = params.get(name := knob_name_prefix + "prefetch_b_k") or knob(name)
    prefetch_b_n = params.get(name := knob_name_prefix + "prefetch_b_n") or knob(name)
